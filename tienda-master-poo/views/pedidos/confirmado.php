<?php if (isset($_SESSION['pedido']) && $_SESSION['pedido'] == 'complete') : ?>
    ...
    <p>Tu pedido ha sido guardado con exito, una vez que realices la transferencia bancaria a la cuenta 789456123 con el coste del pedido, será procesado y enviado.</p>
    <br>
    <?php if (isset($pedido)) :  ?>
